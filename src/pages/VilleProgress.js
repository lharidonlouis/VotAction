...
const VilleProgress = ({ data, numTour, total, inscrits, votants }) => {
  ...
  return (
    <div className='bg-light p-5 my-5 rounded shadow'>
      ...
      {/* <div className='row'>
        <div className='col-6'>
            <div className="px-1 py-2 bg-pastel-primary m-3 rounded shadow-sm">
            <h3 className="text-primary text-center"><FaUsers /><br/> Inscrits</h3>
            <p className="text-muted text-center"><strong>{inscrits}</strong></p>
            </div>
        </div>
        <div className='col-6'>
            <div className="px-1 py-2 bg-pastel-info m-3 rounded shadow-sm">
        ...
        <div className='col-6'>
            <div className="px-1 py-2 bg-pastel-success m-3 rounded shadow-sm">
            <h3 className="text-success text-center"><FaCheck /><br/> Votants</h3>
            <p className="text-muted text-center"><strong>{votants}</strong></p>
            </div>
        </div>
        <div className='col-6'>
            <div className="px-1 py-2 bg-pastel-secondary m-3 rounded shadow-sm">
            ...
            <div className='row py-3 px-2 bg-white m-3 rounded shadow'>
              <div className='col-12 col-xl-6 align-items-center d-flex  d-xl-inline-flex justify-content-start justify-content-xl-center'>
                ...
                <p className='h6 text-left'>
                  ...
                  <span className='text-muted'>{inscrits}</span>
                </p>
              </div>
              <div className='col-12 col-xl-6 align-items-center d-flex  d-xl-inline-flex justify-content-start justify-content-xl-center'>
                ...
                <p className='h6 text-left'>
                  ...
                  <span className='text-muted'>{(((inscrits - votants) / inscrits) * 100).toFixed(2)}%</span>
                </p>
              </div>
              <div className='col-12 col-xl-6 align-items-center d-flex  d-xl-inline-flex justify-content-start justify-content-xl-center'>
                <p style={{ fontSize: '2.5rem' }}>
                ...
                <p className='h6 text-left'>
                  ...
                  <span className='text-muted'>{votants}</span>
                </p>
              </div>
              <div className='col-12 col-xl-6 align-items-center d-flex  d-xl-inline-flex justify-content-start justify-content-xl-center'>
                <p style={{ fontSize: '2.5rem' }}>
                ...
                <p className='h6 text-left'>
                  ...
                  <span className='text-muted'>{votants - total}</span>
                </p>
              </div>
            </div>
          </div>
        ...
        .map((item, index) => (
          ...
          <div key={Math.random() * 1000} className='my-2 shadow p-4 bg-white w-100 align-item-center'>
            ...
            <ProgressBar className='shadow'
              ...
              style={{
                height: '30px',
                backgroundColor: getBackgroundColor(item.codnua, 0.5),
              }}
            >
              <div
                style={{
                  ...
                  height: '100%',
                  backgroundColor: getBackgroundColor(item.codnua, 0.8),
                }}
              />
